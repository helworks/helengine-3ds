...
HELENGINE_3DS_RENDER_DIAGNOSTIC_MODE ?= 0
HELENGINE_3DS_SKIP_DRAW_ARRAYS ?= 0
HELENGINE_3DS_SAFE_DRAW_ARRAYS ?= 0
HELENGINE_3DS_RENDER_TRACE_ENABLED ?= 0
_3DSXFLAGS :=
TOPDIR ?= $(CURDIR)
...
CFLAGS := \
	...
	-fdata-sections \
	$(ARCH) \
	-DHELENGINE_3DS_RENDER_DIAGNOSTIC_MODE=$(HELENGINE_3DS_RENDER_DIAGNOSTIC_MODE) \
	-DHELENGINE_3DS_SKIP_DRAW_ARRAYS=$(HELENGINE_3DS_SKIP_DRAW_ARRAYS) \
	-DHELENGINE_3DS_SAFE_DRAW_ARRAYS=$(HELENGINE_3DS_SAFE_DRAW_ARRAYS) \
	-DHELENGINE_3DS_RENDER_TRACE_ENABLED=$(HELENGINE_3DS_RENDER_TRACE_ENABLED)
