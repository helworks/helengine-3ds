...
/// <summary>
/// Verifies the Nintendo 3DS builder adopts the generated boot-scene startup contract.
/// </summary>
...
public class Nintendo3DsGeneratedBootSceneContractTests {
    ...
    /// <summary>
    /// Verifies Nintendo 3DS builds use the generated boot scene as the effective startup scene even when the authored manifest names another startup scene.
    /// </summary>
    [Fact]
        ...
        try {
            ...
            PlatformBuildScene[] scenes = [
                new PlatformBuildScene(
                    ...
                    [new KeyValuePair<string, string>(PlatformBuildSceneMetadataKeys.CookedRelativePath, Nintendo3DsStartupSceneIds.GeneratedBootSceneCookedRelativePath)])
            ];
